function loadYouTubeVideos() {
  gapi.client.init({
    ...
    const videoIds = ["njuAEJkIkfU", "GbBd6NiToVo", "jzY0TO2b1Ug", "hw0XgEW2TcU", "GrkYFzS3_2s"];
    videoIds.forEach((videoId, index) => {
      gapi.client.youtube.videos.list({part: "player", id: videoId}).then(response => {
        ...
        document.getElementById(`video${index + 1}`).appendChild(videoElement);
      }, error => {
